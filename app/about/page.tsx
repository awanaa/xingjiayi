  ...
  const t = {
    en: {
      ...
      stats: [
        ...
        { end: 500, suffix: "+", label: "Dedicated Employees" },
      ...
      milestones: [
        { year: "2005", event: "Founded in Shenzhen, laying the foundation for paper manufacturing excellence." },
        ...
        { year: "2020-2022", event: "Introduced fully automated production lines and completed our digital factory transformation." },
        { year: "2024", event: "Launched the next-generation intelligent smart factory, setting new industry benchmarks." },
      ],
    ...
    zh: {
      ...
      heroTitle: "纸艺匠心，",
      heroAccent: "折叠童年奇境。",
      heroDesc: "全球知名的儿童立体书、教育套装及精密纸艺工程制造企业。",
      scroll: "探索我们的故事",
      profileTitle: "企业全貌",
      stats: [
        { end: 20, suffix: "+", label: "年行业经验" },
        { end: 500, suffix: "+", label: "专业员工" },
      ...
      timelineTitle: "发展历程",
      milestones: [
        { year: "2005", event: "星嘉艺于深圳正式成立，开启纸艺制造之路。" },
        ...
        { year: "2020-2022", event: "全面引入全自动生产线，完成数字工厂智能化改造。" },
        { year: "2024", event: "新一代智能工厂正式启航，树立行业新标杆。" },
      ],
      certTitle: "全球信任与资质",
      ctaTitle: "准备好开启新项目了吗？",
    ...
    ja: {
      ...
      profileTitle: "会社概要",
      stats: [
        { end: 20, suffix: "+", label: "年の経験" },
        { end: 500, suffix: "+", label: "従業員数" },
        { end: 30, suffix: "+", label: "輸出対象国" },
        { end: 98, suffix: "%", label: "顧客満足度" },
      ],
      ...
      timelineTitle: "沿革",
      milestones: [
        { year: "2005", event: "深センにて設立。ペーパーマニュファクチャリングの基盤を構築。" },
        ...
        { year: "2020-2022", event: "完全自動生産ラインを導入し、デジタル工場化を完了。" },
        { year: "2024", event: "次世代スマート工場を稼働。業界の新たなベンチマークを確立。" },
      ],
    ...
    ko: {
      ...
      profileTitle: "회사 소개",
      stats: [
        { end: 20, suffix: "+", label: "년의 경험" },
        { end: 500, suffix: "+", label: "명의 직원" },
      ...
      timelineTitle: "연혁",
      milestones: [
        { year: "2005", event: "선전에서 설립되어 종이 공예 제조의 길을 열었습니다." },
        ...
        { year: "2020-2022", event: "전자동 생산 라인을 도입하여 디지털 공장의 지능형 혁신을 완료했습니다." },
        { year: "2024", event: "차세대 스마트 공장이 출범하여 업계의 새로운 기준을 세웠습니다." },
      ],
    ...
    heroSub: "Since 2005", heroTitle: "Crafting Childhood", heroAccent: "Wonders.",
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              ...
              <div key={i} className="group flex flex-col items-center gap-3">
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl border border-white/[0.06] p-3 bg-white/[0.02] flex items-center justify-center hover:border-gold-500/30 transition-all duration-300">
                  <OptimizedImage src={cert.src} alt={cert.name} wrapperClassName="w-full h-full" className={`w-full h-full object-contain group-hover:scale-110 transition-all duration-500 ${cert.invert ? 'invert' : ''}`} />
                </div>
                <span className="text-[10px] text-white/40 tracking-wider font-mono">{cert.name}</span>
              </div>
            ))}
          </div>
        </div>
